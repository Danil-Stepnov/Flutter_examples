...
class _$_ItemsModel implements _ItemsModel {
  ...
  @override
  String toString() {
    return 'ItemsModel(id: $id, title: $title, slug: $slug, image: $image, price: $price, colors: $colors, category: $category)';
  }
  ...
  @JsonKey(ignore: true)
  @override
  int get hashCode => Object.hash(runtimeType, id, title, slug, image, price,
      const DeepCollectionEquality().hash(_colors), category);
...
abstract class _ItemsModel implements ItemsModel {
  const factory _ItemsModel(
      ...
      required final List<ColorsModel>? colors,
      required final CategoryModel? category}) = _$_ItemsModel;
